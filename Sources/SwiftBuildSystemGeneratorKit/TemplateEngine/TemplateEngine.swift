...
class TemplateEngine {
    ...
    func render(templateName: String, context: [String: Any], _ options: Options) throws -> String {
        let environment = Environment(loader: FileSystemLoader(paths: [.init(options.templatePath)]))
