    ...
    enum Kind: CustomStringConvertible {
        ...
        public var description: String {
            ...
            case .multipleVersionsFoundForModule(let moduleName, let versionSpecs):
                return "Multiple versions found for module '\(moduleName)': '\(versionSpecs)'. Make sure the version resolvers specified in the '\(BsgFile.fileName).yml' file are correct"
